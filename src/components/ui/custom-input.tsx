...
//   return (
//     <label className={cn("mt- w-full h-[30px] flex rounded border-2 shadow-sm hover:border-[#6A6A6A] transition-colors overflow-hidden", "focus-within:!border-[#726FFF]")}>
//       {children && <div className="h-full w-12 flex items-center justify-center text-xs text-muted-foreground bg-[#272727]">{children}</div>}

//       <input
//         type={type}
//         className={cn(
//           "flex h-full w-full bg-[#272727] pr-2 py-1 text-xs outline-none border-none disabled:cursor-not-allowed disabled:opacity-50 file:bg-transparent  file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground",
//           className,
//           {
//             "pl-2": !children,
//           }
