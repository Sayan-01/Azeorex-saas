...
const Try1 = () => {
  ...
  const moveObject = (data: Content[], id1: string, id2: string) => {
    console.log("sayan", id1, id2);

    const objToMove = findAndRemoveObjectById(data, id1);
    if (objToMove) {
      findAndAddObjectById(data, id2, objToMove);
    }
  };
