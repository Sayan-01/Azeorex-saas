...
const CallToAction = () => {
  return (
    <div className="flex flex-col items-start md:items-center gap-y-5 md:gap-y-0">
      <GradientText
        className="text-[35px] mb-5 text-center md:text-[40px] lg:text-[55px] xl:text-[70px] 2xl:text-[80px] leading-[1.1] font-semibold"
        element="H1"
      >
      ...
      <div className="flex md:flex-row flex-col md:justify-center gap-5 md:mt-5 w-full">
        <Button
          variant="outline"
          className="rounded-xl element bg-transparent text-base"
        >
          Watch Demo
        </Button>
        <Link href="/sign-in">
