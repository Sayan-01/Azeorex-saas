...
import { Camera, CanvasMode, CanvasState, Color, LayerType, Point, Side, XYWH } from "@/types/canvas-types";
import { colorToCss, connectionIdToColor, findIntersectingLayersWithRectangle, penPointsToPathLayer, pointerEventToCanvasPoint, resizeBounds } from "./utils";
const MAX_LAYERS = 100;

// export default function Room() {
//   const roomId = useExampleRoomId("liveblocks:examples:nextjs-whiteboard-advanced");
...
export default function Canvas() {
  ...
  const onPointerMove = useMutation(
    ...
    [camera, canvasState, continueDrawing, resizeSelectedLayer, startMultiSelection, translateSelectedLayers, updateSelectionNet]
  );
