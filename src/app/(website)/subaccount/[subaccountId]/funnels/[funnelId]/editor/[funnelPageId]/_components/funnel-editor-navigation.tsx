...
const FunnelEditorNavigation = ({ funnelId, funnelPageDetails, subaccountId }: Props) => {
  ...
  return (
    <TooltipProvider>
      <nav className={clsx("border-b border-main-black flex items-center justify-between px-3 py-1 gap-2 transition-all", { "!h-0 !p-0 !overflow-hidden": state.editor.previewMode })}>
